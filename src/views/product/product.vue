      ...
      <div class="w_1200">
        ...
        <div class="coreShow">
          ...
          <div class="coreImgBox">
            <span v-show="coreShow.imgList.length>1" @click="checkoutImg('pre')" class="imgBtn pre">
              <a-icon type="left" />
            </span>
            ...
            <span v-show="coreShow.imgList.length>1" @click="checkoutImg('next')" class="imgBtn next">
              <a-icon type="right" />
            </span>
          </div>
        </div>
