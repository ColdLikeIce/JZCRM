      ...
      <div class="coreList">
       ...
       <div class="coreShow">
        ...
        <div class="coreImgBox">
          <span v-show="coreImgList.length>1" @click="checkoutImg('pre')" :class="{'disabled':currentId===0}" class="imgBtn pre"><a-icon type="left" /></span>
          ...
          <span v-show="coreImgList.length>1" @click="checkoutImg('next')" :class="{'disabled':currentId===coreImgList.length-1}" class="imgBtn next"><a-icon type="right" /></span>
        </div>
       </div>
      </div>
    </div>
